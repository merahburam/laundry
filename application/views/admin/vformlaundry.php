     ...
     <form action="<?=base_url()?>admin/inputdata/form/<?=$aksi?>" method="post">
       ...
       <tr>
          ...
          <td>
          		...
          		<td>
           		<div class="radio">
      				&nbsp;&nbsp;&nbsp;&nbsp;<label><input type="radio" name="paket" required value="Paket 1" <? if($aksi=="aksi_edit"){if($nokamar=='Paket 1'){echo"selected=selected";}}?>>Paket 1 Bulan
      				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
    			</div>
    			</td>
    			...
    			<div class="radio">
      				<label><input type="radio" name="paket" required value="Paket 6" <? if($aksi=="aksi_edit"){if($nokamar=='Paket 6'){echo"selected=selected";}}?>>Paket 6 Bulan</label>
    			</div>
    			</td>
    			</tr>
    			</table>
